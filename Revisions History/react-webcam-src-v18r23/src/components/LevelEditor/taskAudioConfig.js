...
export const DEFAULT_LEVEL_SUMMARY_AUDIO_OPTIONS = [
    ...
    { value: 'Lvl_begint.END_BAD', label: 'Lvl_begint.END_BAD' },
    { value: 'Lvl_begint.END_GOOD', label: 'Lvl_begint.END_GOOD' },
    { value: 'Lvl_begint.END_PERFECT', label: 'Lvl_begint.END_PERFECT' },
    { value: 'Lvl_quickbg.END_BAD', label: 'Lvl_quickbg.END_BAD' },
    { value: 'Lvl_quickbg.END_GOOD', label: 'Lvl_quickbg.END_GOOD' },
    { value: 'Lvl_quickbg.END_PERFECT', label: 'Lvl_quickbg.END_PERFECT' },
    { value: 'Lvl_cockw.END', label: 'Lvl_cockw.END' },
]
