 ...
 * @param {function} [onPasteTask] - () => void append clipboard at end
    ...
    const addTaskBar = (
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <button
                ...
                title={
                    clipboardTask
                        ? `Paste copied ${clipboardPasteTitle} task at end of list`
                        : 'Nothing in clipboard — use Copy on a task first'
                }
                aria-label={
                    clipboardTask
                        ? `Paste copied ${clipboardPasteTitle} task at end of task list`
