            ...
            <div className="instructions-content">
                ...
                <section className="instruction-section">
                    ...
                    <ul>
                        ...
                        <li><strong>Rest</strong> - Catch your breath.  If told to lick the balls, this isn't actually tracked in default levels. Configure a "Balls region" grid, and enable "Balls Bonus" in the Rest task, to earn bonus points in custom levels.</li>
