...
const LevelEditor = () => {
    ...
    const handlePasteTask = () => {
        ...
        setLevel((prev) => ({ ...prev, tasks: [...prev.tasks, pasted] }))
    }
    ...
    return (
        <>
            ...
            <p className="margin-y-sm" style={{ color: '#666', fontSize: '13px' }}>
                Export writes one .json file per custom level in the Folder dropdown above
                (All Folders or a single subfolder). Import reads every valid level file in a chosen directory.
            </p>
