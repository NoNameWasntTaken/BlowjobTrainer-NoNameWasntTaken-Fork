...
function Diving({ task, onTaskOver, onSignalCaptureWindow, isLastTask }) {
    ...
    useEffect(() => {
        ...
        const id = setInterval(() => {
            ...
            onSignalCaptureWindow(w, { photos: false, videos: w && timeLeftRef.current >= vidMin })
        }, 1000)
    ...
    }, [motion.dir, setDiveScores, provideFeedback, setScore, hasStarted, stopVibration, diveState, setFeedback, targetDepthDown])
