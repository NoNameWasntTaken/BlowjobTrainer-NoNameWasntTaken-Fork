            ...
            <div className='grid-two' >
                ...
                <div>
                    <div className='border-grey margin-y padding-x padding-y-md'>
                        ...
                        <div className='margin-y-sm'>
                            <p className='margin-y-sm'>Audio Pack (coming soon):</p>
                            <select
                                disabled
                                value={audioPackId || ''}
                                onChange={(e) => setAudioPackId(e.target.value || null)}
                            >
                                <option value="">Default Audio Pack</option>
                            ...
                            <small style={{ color: '#666' }}>Select a custom audio pack for this level</small>
                        </div>
                    </div>
