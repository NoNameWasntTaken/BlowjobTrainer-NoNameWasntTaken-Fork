            ...
            <div className="instructions-content">
                ...
                <section className="instruction-section">
                    ...
                    <ul>
                        ...
                        <li><strong>Speak</strong> - Say a phrase out loud. Watch the UI to see what the system heard; speak up! Not used in default levels.</li>
                        <li><strong>Endless</strong> - Long task with no hold or suck targets - go wild! Earn rest by scoring. Earn bonus points for deeper holds, consistent depth and rhythm in dives, and licking the balls during rest. Not used in default levels.</li>
                    </ul>
                    <p>*Licking the balls can be tracked in custom levels. Configure a "Balls region" grid, and enable "Balls Bonus" in the Rest task. During rest, stay on the balls for at least 3 seconds to earn bonus points.</p>
                </section>
                <section className="instruction-section">
