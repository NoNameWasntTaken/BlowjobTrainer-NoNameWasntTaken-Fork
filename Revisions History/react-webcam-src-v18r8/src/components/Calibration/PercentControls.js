...
import { gridDepthPercentAtom, percentHysterisisAtom } from "../../atoms/gridAtoms";
import { STR } from "../../constants/stringsreplace";

function PercentControls() {
    ...
    return (
        <React.Fragment>
            ...
            <div className="row-centered flex-wrap">
                <NumberControl label={STR.Depth[1]} value={p1} setValue={setP1} min={0} max={100} />
                <NumberControl label={STR.Depth[2]} value={p2} setValue={setP2} min={0} max={100} />
                <NumberControl label={STR.Depth[3]} value={p3} setValue={setP3} min={0} max={100} />
                <NumberControl label={STR.Depth[4]} value={p4} setValue={setP4} min={0} max={100} />
            </div>
