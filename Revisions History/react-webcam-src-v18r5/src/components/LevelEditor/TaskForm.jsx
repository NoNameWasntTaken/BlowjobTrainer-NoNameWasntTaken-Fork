...
const TaskForm = ({ task, onChange, onDelete, audioPackId = null }) => {
    ...
    // Executable path field - applies to all task types
        ...
        <div style={{ width: '100%', marginTop: '8px' }}>
            ...
            <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                ...
                <button
                    ...
                    disabled={!isElectron}
                    onClick={async () => {
                        // Service passes relative/absolute path to IPC, main process resolves it
                        ...
                        // Only update if user selected a file (not canceled)
                        if (selected) {
                            updateTask({ executablePath: selected });
                        }
                        // If canceled (selected === null), leave current path as-is
                    }}
                ...
                <button
                    ...
                    onClick={async () => {
                        ...
                        // Test button uses same execution path as gameplay
