    ...
    const addTaskBar = (
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <button
                ...
                style={{ padding: '6px 12px', opacity: !clipboardTask ? 0.45 : 1 }}
                title={
                    clipboardTask
            ...
            <div>
                {tasks.length === 0 ? (
                    ...
                    tasks.map((task, index) => {
                        ...
                        <div
                            key={task.id || index}
                            className={[fixed ? 'task-bookend' : '', fixed && !expanded ? 'task-bookend-collapsed' : ''].filter(Boolean).join(' ')}
                        ...
                        >
                            ...
                            {fixed && !expanded ? (
                                <button
                                    type="button"
                                    className="task-bookend-summary"
                                    aria-expanded="false"
                                    ...
                                    <>
                                        <button
                                            ...
                                            style={{
                                                padding: '2px 6px',
                                                fontSize: '12px',
                                                opacity: index === firstMovable ? 0.3 : 1
                                            }}
                                        ...
                                        <button
                                            ...
                                            style={{
                                                padding: '2px 6px',
                                                fontSize: '12px',
                                                opacity: index === lastMovable ? 0.3 : 1
                                            }}
