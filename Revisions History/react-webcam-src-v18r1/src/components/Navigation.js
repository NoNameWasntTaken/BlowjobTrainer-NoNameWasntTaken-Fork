...
import { Settings, Compass, Book, Play, Pause, Circle, Award, HelpCircle, Mic as MicIcon, Zap, Edit, Music, Folder } from 'react-feather'
...
function Navigation() {
    ...
    return (
        <div>
            ...
            {/* Row 2: Content Library, Audio Pack Editor, Edit Levels, Achievements */}
            <div className='navigation-row margin-y'>
                <button
                ...
                <button
                    ...
                    <Music size={18} className="margin-xr-sm" /> Audio Pack Editor
                </button>
                <button
                ...
                <button
                    ...
                    <Award size={18} className="margin-xr-sm" /> Achievements
                </button>
            </div>
        </div>
    )
