export const AUDIO_HELPER = {
    ...
    UpDown: {
        ...
        ONE_THREE_MED: { description: 'Medium speed transition from position one to three', defaultText: 'One to three' },
        ...
        ONE_FOUR_MED: { description: 'Medium speed transition from position one to four', defaultText: 'One to four' },
    ...
    Warmup: {
        ...
        HOLD_THREE: { description: 'Warmup hold position three', defaultText: 'Hold three' },
        HOLD_FOUR: { description: 'Warmup hold position four', defaultText: 'Hold four' },
    },
    ...
    Custom: {
        desc: 'User-defined voice lines. The line name is what levels store. Older Custom1–Custom40 lines still work.',
    },
}
