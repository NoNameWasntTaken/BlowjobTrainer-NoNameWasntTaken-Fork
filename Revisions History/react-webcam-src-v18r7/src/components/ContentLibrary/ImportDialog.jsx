        ...
        <div className="import-dialog-overlay" onClick={onClose}>
            <div className="import-dialog" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="dialog-content">
                    ...
                    {error && (
                        <div style={{ padding: '12px', backgroundColor: '#ffebee', color: '#c62828', borderRadius: '4px', marginTop: '12px' }}>
                            <strong>Error:</strong> {error}
                        </div>
                    )}

                    {warnings.length > 0 && (
                        <div style={{ padding: '12px', backgroundColor: '#fff3e0', color: '#e65100', borderRadius: '4px', marginTop: '12px' }}>
