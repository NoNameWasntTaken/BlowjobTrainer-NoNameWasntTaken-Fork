...
const CUSTOM_SUBCATEGORIES = Array.from({ length: 20 }, (_, i) => `Custom${i + 1}`)
...
const AudioPackEditor = () => {
    ...
    const categoryGroups = [
        ...
        },
        {
            ...
            categories: ['Warmup', 'Hit', 'UpDown', 'Hold', 'Clap', 'Rest', 'HoldAndClap', 'Endless']
        },
        {
            heading: 'Performance',
                ...
                {processedGroups.map((group, groupIndex) => (
                    <div key={group.heading} className="category-group">
                        ...
                        {group.categories.map(category => {
                            const keys = category === 'Custom' ? CUSTOM_SUBCATEGORIES : Object.keys(AUDIO[category] || {})
                            return (
                                <AudioCategoryEditor
                                    key={category}
                                    packId={pack.id}
