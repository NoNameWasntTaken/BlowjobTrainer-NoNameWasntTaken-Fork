...
export const levels = [
    ...
    //     tasks: [
    //         { type: TaskType.GETREADY, audio: 'Level.START_00', desc: "get ready", time: 3, timeLimit: 10 },
    ...
    // A beginner-friendly session focusing on shallow depths and basic techniques
    {
        ...
        summaryAudio: {
            failed: AUDIO.Lvl_begint.END_BAD,
            apprentice: AUDIO.Rank.END_PASS,
            journeyman: AUDIO.Lvl_begint.END_GOOD,
            master: AUDIO.Lvl_begint.END_PERFECT,
        },
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: 'Lvl_begint.START', desc: "get ready", time: 15, timeLimit: 15 },
            createHOLDTask({ targetDepth: 1, time: 5, repeat: 3 }),
    ...
    // A quick blow and go session, nothing too heavy, perfect for building initial confidence
    {
        ...
        summaryAudio: {
            failed: AUDIO.Lvl_quickbg.END_BAD,
            apprentice: AUDIO.Rank.END_PASS,
            journeyman: AUDIO.Lvl_quickbg.END_GOOD,
            master: AUDIO.Lvl_quickbg.END_PERFECT,
        },
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: 'Lvl_quickbg.START', desc: "get ready", timeLimit: 10 },
    ...
    // Perfect for mastering the fundamentals of controlled movement
    {
        ...
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: 'Lvl_basicr.START', desc: "get ready", timeLimit: 15 },
            ...
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30, audio: 'Lvl_basicr.PRE_RELEASE' }),
            // Cool down with controlled movements
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 15, audio: 'Lvl_basicr.POST_RELEASE' }),
    ...
    // A longer slow session, no dep throats, but be get comfy on your knees
    {
        ...
        summaryAudio: {
            ...SOFT_SUMMARY_AUDIO,
            master: AUDIO.Lvl_cockw.END,
        },
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: 'Lvl_cockw.START', desc: "get ready", timeLimit: 15 },
            ...
            createRESTTask({ audio: 'Rest.REST', timeLimit: 15 }),
            // Cool down phase
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30, audio: 'Lvl_cockw.PRE_RELEASE_1' }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 15, audio: 'Lvl_cockw.PRE_RELEASE_2' }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 15, audio: 'Lvl_cockw.PRE_RELEASE_3' }),
            createRESTTask({ audio: 'Lvl_cockw.POST_RELEASE', timeLimit: 15 }),
            createFINISHTask({}),
        ]
    },
    ...
    // Step up your training with more challenging depths and tempos
    {
        ...
        tasks: [
            // intro
            { type: TaskType.GETREADY, audio: 'Level.INTMED_5', desc: "get ready", time: 15, timeLimit: 15 },
    ...
    // 6 - Endurance Builder
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.ENDURANCE_6', desc: "get ready", timeLimit: 15 },
            // Warm up phase
    ...
    // 7 - Deep Focus
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.DEEPFOCUS_7', desc: "get ready", timeLimit: 15 },
            // Initial warm-up
            createHOLDTask({ targetDepth: 2, time: 10, repeat: 3 }),
    ...
    // 8 - Speed Training
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.SPEED_8', desc: "get ready", timeLimit: 10 },
            // Quick warm-up
            createCLAPTask({ repeat: 10 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.FAST, timeLimit: 30 }),
    ...
    // 9 - Diver devotion
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.DEVOTION_9', desc: "get ready", timeLimit: 15 },
            // Warm up phase
            createCLAPTask({ repeat: 12 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 45 }),
            createRESTTask({ audio: 'Rest.SHORT_REST', timeLimit: 10 }),
    ...
    // 10 - Max Depth Master
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.MAXDEPTH_10', desc: "get ready", timeLimit: 15 },
            // Initial warm-up
            createCLAPTask({ repeat: 10 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 45 }),
            createRESTTask({ audio: 'Rest.REST', timeLimit: 15 }),
    ...
    // 11 - Elite Endurance
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.ELITE_11', desc: "get ready", timeLimit: 15 },
            // First phase
            createCLAPTask({ repeat: 12 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 60 }),
    ...
    // 12 - Many Load Challenge
    {
        ...
        summaryAudio: { ...BASELINE_SUMMARY_AUDIO },
        tasks: [
            { type: TaskType.GETREADY, audio: 'Level.MANYLOAD_12', desc: "get ready", timeLimit: 15 },
            // Phase 1 - Speed focus
            createCLAPTask({ repeat: 15 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.FAST, timeLimit: 45 }),
