...
function BaseColorControls({ disabled = false }) {
                ...
                <div className='row-centered flex-wrap'>
                    ...
                    <div>
                        ...
                        <button 
                            ...
                            disabled={disabled || isAllGridsMode || !selectedGrid || !selectedGrid.squares || selectedGrid.squares.length === 0 || !gridAverageColors[selectedGrid.id]}
                        >
