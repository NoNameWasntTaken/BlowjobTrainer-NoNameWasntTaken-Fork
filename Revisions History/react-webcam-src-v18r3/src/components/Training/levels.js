import { TaskType, Tempo, createHOLDTask, createUPANDDOWNTask, createRESTTask, createHITTask, createCLAPTask, createFINISHTask, createENDLESSTask } from "../Tasks/task";
...
export const levels = [
    ...
    //     tasks: [
    //         { type: TaskType.GETREADY, audio: AUDIO.Level.START_00, desc: "get ready", time: 3, timeLimit: 10 },
    //         createCLAPTask({ repeat: 20 }),
    //         createCLAPTask({ repeat: 12, audio: AUDIO.Clap.BELOW }),
    ...
    //         // createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.SLOW, audio: AUDIO.UpDown.ONE_THREE_SLOW, timeLimit: 20 }),
    //         // createHITTask({ targetDepth: 4, repeat: 2 }),
    //         // createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 8 }),
    ...
    //         createHITTask({ targetDepth: 4, repeat: 10, audio: AUDIO.Warmup.HIT_FOUR }),
    //         createUPANDDOWNTask({ minDepth: 1, maxDepth: 4, tempo: Tempo.SLOW, timeLimit: 1000 }),
    //         createENDLESSTask({}),
    //         createFINISHTask({}),
    //     ]
    ...
    // A beginner-friendly session focusing on shallow depths and basic techniques
    {
        ...
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Lvl_begint.START, desc: "get ready", time: 15, timeLimit: 15 },
            createHOLDTask({ targetDepth: 1, time: 5, repeat: 3 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 10 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.SLOW, audio: AUDIO.UpDown.ONE_TWO_SLOW, timeLimit: 60 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 10 }),
            createHITTask({ targetDepth: 2, repeat: 5 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 10 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.SLOW, timeLimit: 60 }),
            createRESTTask({ audio: AUDIO.Rest.REST_BALL, timeLimit: 15 }),
            ...
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, audio: AUDIO.Release.PRE_RELEASE, timeLimit: 30 }),
            createHOLDTask({ targetDepth: 1, time: 10, repeat: 1, audio: AUDIO.Release.POST_RELEASE }),
            createFINISHTask({}),
        ]
    },
    ...
    // A quick blow and go session, nothing too heavy, perfect for building initial confidence
    {
        ...
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Lvl_quickbg.START, desc: "get ready", timeLimit: 10 },
            createHOLDTask({ targetDepth: 1, time: 10, repeat: 3 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.SLOW, audio: AUDIO.UpDown.SLOW, timeLimit: 45 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            createHITTask({ targetDepth: 3, repeat: 10, audio: AUDIO.Warmup.HIT_THREE }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, audio: AUDIO.UpDown.ONE_THREE_MEDIUM, timeLimit: 30 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, audio: AUDIO.UpDown.ONE_THREE_FAST, timeLimit: 30 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 10 }),
            createHITTask({ targetDepth: 4, repeat: 4, audio: AUDIO.Warmup.HIT_FOUR }),
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 5 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, audio: AUDIO.UpDown.ONE_THREE_FAST, timeLimit: 20 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, audio: AUDIO.Release.PRE_KEEP_GOING, timeLimit: 20 }),
            createHOLDTask({ targetDepth: 1, time: 15, audio: AUDIO.Release.HOLD_SWALLOW, repeat: 1 }),
            createFINISHTask({}),
        ]
    },
    ...
    // Perfect for mastering the fundamentals of controlled movement
    {
        ...
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Lvl_basicr.START, desc: "get ready", timeLimit: 15 },
            ...
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 5 }),
            // Hold practice at depth 2
            createHOLDTask({ targetDepth: 3, time: 4, repeat: 4, audio: AUDIO.Warmup.HOLD_THREE }),
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 5 }),
            ...
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30, audio: AUDIO.Lvl_basicr.PRE_RELEASE }),
            // Cool down with controlled movements
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 15, audio: AUDIO.Lvl_basicr.POST_RELEASE }),
            createRESTTask({ audio: AUDIO.Release.POST_RELEASE_ZERO, timeLimit: 15 }),
            createFINISHTask({}),
        ]
    },
    ...
    // A longer slow session, no dep throats, but be get comfy on your knees
    {
        ...
        soft: true,
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Lvl_cockw.START, desc: "get ready", timeLimit: 15 },
            ...
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 10 }),
            ...
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            // Cool down phase
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30, audio: AUDIO.Lvl_cockw.PRE_RELEASE_1 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 15, audio: AUDIO.Lvl_cockw.PRE_RELEASE_2 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 15, audio: AUDIO.Lvl_cockw.PRE_RELEASE_3 }),
            createRESTTask({ audio: AUDIO.Lvl_cockw.POST_RELEASE, timeLimit: 15 }),
            createFINISHTask({}),
        ]
    },
    ...
    // Step up your training with more challenging depths and tempos
    {
        ...
        tasks: [
            // intro
            { type: TaskType.GETREADY, audio: AUDIO.Level.INTMED_5, desc: "get ready", time: 15, timeLimit: 15 },
            createHOLDTask({ targetDepth: 2, time: 5, repeat: 4 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 45 }),
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 5 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 30 }),
            createHITTask({ targetDepth: 3, repeat: 6, audio: AUDIO.Warmup.HIT_THREE }),
            createRESTTask({ audio: AUDIO.Rest.REST_BALL, timeLimit: 10 }),
            // down to throat
            createHOLDTask({ targetDepth: 3, time: 8, repeat: 4, audio: AUDIO.Hold.HOLD_THREE }),
            ...
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 10 }),
            // again
            createHITTask({ targetDepth: 4, repeat: 4, audio: AUDIO.Hit.HIT_FOUR }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 10 }),
            // new task!
            ...
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 5 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, timeLimit: 30 }),
            createRESTTask({ audio: AUDIO.Rest.REST_BALL, timeLimit: 20 }),
            // deeper challenge
            ...
            // finale time
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, timeLimit: 30 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, audio: AUDIO.Release.PRE_RELEASE, timeLimit: 15 }),
            createHOLDTask({ targetDepth: 2, time: 15, repeat: 1, audio: AUDIO.Release.POST_RELEASE }),
            createFINISHTask({}),
        ]
    },
    ...
    // 6 - Endurance Builder
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.ENDURANCE_6, desc: "get ready", timeLimit: 15 },
            // Warm up phase
            ...
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            createCLAPTask({ repeat: 20, audio: AUDIO.Clap.BELOW }),
            // Endurance challenge
            ...
            createHOLDTask({ targetDepth: 4, time: 4, repeat: 6, audio: AUDIO.Warmup.HOLD_FOUR }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.SLOW, timeLimit: 60 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 20 }),
            // Final push
            createCLAPTask({ repeat: 20, audio: AUDIO.Clap.BELOW }),
            ...
            // Final sequence
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, audio: AUDIO.Release.PRE_RELEASE, timeLimit: 15 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.SLOW, audio: AUDIO.Release.POST_RELEASE, timeLimit: 15 }),
            createFINISHTask({}),
        ]
    },
    ...
    // 7 - Deep Focus
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.DEEPFOCUS_7, desc: "get ready", timeLimit: 15 },
            // Initial warm-up
            createHOLDTask({ targetDepth: 2, time: 10, repeat: 3 }),
            ...
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 15, audio: AUDIO.Release.PRE_RELEASE }),
            createHOLDTask({ targetDepth: 4, time: 6, repeat: 1, audio: AUDIO.Release.POST_RELEASE_FOUR }),
            // finish
            createFINISHTask({}),
        ]
    },
    ...
    // 8 - Speed Training
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.SPEED_8, desc: "get ready", timeLimit: 10 },
            // Quick warm-up
            createCLAPTask({ repeat: 10 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.FAST, timeLimit: 30 }),
    ...
    // 9 - Diver devotion
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.DEVOTION_9, desc: "get ready", timeLimit: 15 },
            // Warm up phase
            createCLAPTask({ repeat: 12 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 45 }),
            createRESTTask({ audio: AUDIO.Rest.SHORT_REST, timeLimit: 10 }),
            ...
            createHOLDTask({ targetDepth: 4, time: 4, repeat: 4, audio: AUDIO.Warmup.HOLD_FOUR }),
            createRESTTask({ audio: AUDIO.Rest.REST_BALL, timeLimit: 20 }),
            // Rhythm section
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.SLOW, timeLimit: 60 }),
            createCLAPTask({ repeat: 10, audio: AUDIO.Clap.BELOW }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            // Endurance building
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 90 }),
    ...
    // 10 - Max Depth Master
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.MAXDEPTH_10, desc: "get ready", timeLimit: 15 },
            // Initial warm-up
            createCLAPTask({ repeat: 10 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.MEDIUM, timeLimit: 45 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            ...
            createHITTask({ targetDepth: 4, repeat: 6, audio: AUDIO.Warmup.HIT_FOUR }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            // Deep work phase 1
            createHOLDTask({ targetDepth: 4, time: 4, repeat: 6 }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.SLOW, timeLimit: 45 }),
            ...
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, audio: AUDIO.Release.PRE_RELEASE, timeLimit: 15 }),
            createHOLDTask({ targetDepth: 4, time: 20, repeat: 1, audio: AUDIO.Release.POST_RELEASE_FOUR }),
            createCLAPTask({ repeat: 10 }),
            createFINISHTask({}),
        ]
    },
    ...
    // 11 - Elite Endurance
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.ELITE_11, desc: "get ready", timeLimit: 15 },
            // First phase
            createCLAPTask({ repeat: 12 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 60 }),
            ...
            createRESTTask({ audio: AUDIO.Rest.REST_BALL, timeLimit: 20 }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 3, tempo: Tempo.FAST, timeLimit: 40 }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 3, tempo: Tempo.FAST, timeLimit: 15, audio: AUDIO.Release.PRE_RELEASE }),
            createRESTTask({ audio: AUDIO.Release.POST_RELEASE_ZERO, timeLimit: 15 }),
            // Midpoint checkpoint
            createFINISHTask({}),
            // Second phase
            ...
            createHITTask({ targetDepth: 4, repeat: 8 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, timeLimit: 45 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.FAST, timeLimit: 45, audio: AUDIO.Release.PRE_RELEASE }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.SLOW, timeLimit: 30, audio: AUDIO.Release.POST_RELEASE }),
            createFINISHTask({}),
        ]
    },
    ...
    // 12 - Many Load Challenge
    {
        ...
        tasks: [
            { type: TaskType.GETREADY, audio: AUDIO.Level.MANYLOAD_12, desc: "get ready", timeLimit: 15 },
            // Phase 1 - Speed focus
            createCLAPTask({ repeat: 15 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 2, tempo: Tempo.FAST, timeLimit: 45 }),
            ...
            createHOLDTask({ targetDepth: 3, time: 6, repeat: 4 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            createCLAPTask({ repeat: 15, audio: AUDIO.Clap.BELOW }),
            ...
            createHOLDTask({ targetDepth: 2, time: 15, repeat: 1, audio: AUDIO.Release.POST_RELEASE }),
            createFINISHTask({}),
            { type: TaskType.GETREADY, audio: AUDIO.Level.MANYLOAD_12_PHASE2, desc: "get ready", timeLimit: 15 },
            ...
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.MEDIUM, timeLimit: 45 }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.MEDIUM, audio: AUDIO.Release.PRE_RELEASE, timeLimit: 15 }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.SLOW, audio: AUDIO.Release.POST_RELEASE, timeLimit: 15 }),
            createFINISHTask({}),
            { type: TaskType.GETREADY, audio: AUDIO.Level.MANYLOAD_12_PHASE3, desc: "get ready", timeLimit: 15 },
            ...
            createCLAPTask({ repeat: 4 }),
            createRESTTask({ audio: AUDIO.Rest.REST, timeLimit: 15 }),
            createCLAPTask({ repeat: 8, audio: AUDIO.Clap.BELOW }),
            createUPANDDOWNTask({ minDepth: 2, maxDepth: 4, tempo: Tempo.MEDIUM, timeLimit: 60 }),
            createHOLDTask({ targetDepth: 4, time: 6, repeat: 4 }),
            createRESTTask({ audio: AUDIO.Rest.REST_BALL, timeLimit: 20 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 90 }),
            ...
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, timeLimit: 30 }),
            createUPANDDOWNTask({ minDepth: 1, maxDepth: 3, tempo: Tempo.MEDIUM, audio: AUDIO.Release.PRE_RELEASE, timeLimit: 15 }),
            createRESTTask({ audio: AUDIO.Release.POST_RELEASE_ZERO, timeLimit: 30 }),
            createFINISHTask({}),
            { type: TaskType.GETREADY, audio: AUDIO.Level.MANYLOAD_12_WELLDONE, desc: "", timeLimit: 15 },
        ]
    }
];