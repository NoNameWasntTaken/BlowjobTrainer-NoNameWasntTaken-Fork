...
const LevelEditor = () => {
    ...
    useEffect(() => {
        // Load existing custom levels (sorted by level number)
    ...
    const musicTracks = Object.values(musicTrackManager.getAllTracks())
                    ...
                    <div className='border-grey margin-y padding-x padding-y-md'>
                        ...
                        <div className='margin-y-sm'>
                            <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                />
                                Soft Mode (gentler summary feedback)
                            </label>
                        </div>
                        ...
                        <div className='margin-y-sm'>
                            ...
                            <small style={{ color: '#666' }}>
                                {audioPackId 
                                    ? 'Uses the specified voice pack for this level'
                                    : 'Uses the currently selected voice pack in the Content Library'}
                            </small>
                        </div>
                        ...
                        <div className='margin-y-sm'>
                            ...
                            <small style={{ color: '#666', display: 'block', marginTop: '4px' }}>
                                "None" ignores the Content Library and plays no background track. 
                                <br></br>"Use Selected Track in Library" pulls the currently selected background track in the Content Library.
                            </small>
                        </div>
                    </div>
