 ...
 */
const AudioSelector = ({ value, onChange, label = "Voice", allowedOptions = null, audioPackId = null, summaryStyle = false, summaryExtra = null, omitLabel = false, selectStyle: selectStyleProp = undefined }) => {
    ...
    const rootStyle = omitLabel && !summaryStyle
    ...
    return (
        <div style={rootStyle}>
            {!omitLabel && <div style={labelStyle}>{label}:</div>}
            <select
                style={selectStyle}
                value={value || ''}
