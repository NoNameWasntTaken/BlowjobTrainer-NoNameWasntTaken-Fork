...
contextBridge.exposeInMainWorld('electronAPI', {
     ...
     *  Accepts a path string or { defaultPath, title }. */
    showDirectoryPicker: (defaultPathOrOptions) =>
        ipcRenderer.invoke('show-directory-picker', defaultPathOrOptions),
    readJsonFilesFromDirectory: (dirPath) =>
        ipcRenderer.invoke('read-json-files-from-directory', dirPath),
    writeTextFilesToDirectory: (dirPath, files) =>
        ipcRenderer.invoke('write-text-files-to-directory', dirPath, files),
