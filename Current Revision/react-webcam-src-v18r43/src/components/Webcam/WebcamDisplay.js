        ...
        <>
            ...
            <div className="camera-card-footer">
                <div className="camera-source">
                    ...
                    <select
                        id="camera-device"
                        value={cameraVideoDeviceId ?? ''}
                        onChange={(event) => setCameraVideoDeviceId(event.target.value || null)}
                    >
                ...
                {showCameraToggle && (
                    <div className="camera-adjust">
                        <CameraToggle />
                        <label htmlFor="camera-viewport-height-cap" className="camera-height-control">
                            <span>Size {Math.round(viewportHeightCap * 100)}%</span>
                            <input
                        ...
                        <div className="camera-card-toggles">
