...
function Stats() {
    ...
    // Calculate total perfect tasks
    const totalPerfectTasks = Object.values(diveStats.perfectTaskExecutions)
    ...
    // Get number of levels mastered
    const levelsMastered = Object.values(sessionStats.levelScores)
        .filter(score => score.rank === 'MASTER').length
