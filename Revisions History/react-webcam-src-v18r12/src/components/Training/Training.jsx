...
import { feedbackAtom, activePackIdAtom } from '../../atoms/audioAtom';
    ...
    const applyAudioPackForLevel = async (level, { activationRef: actRef } = {}) => {
        ...
        if (isExternalMode) {
            ...
            if (level.audioPackId) {
                ...
                if (pack) audioPackId = level.audioPackId
            }
            if (!audioPackId && cliAudioPackId) audioPackId = cliAudioPackId
