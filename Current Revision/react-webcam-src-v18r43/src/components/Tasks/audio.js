export const AUDIO = {
    ...
    Sfx: {
        ...
        PICTURE: 'audio/sfx/capture_picture.mp3',
        VIDEO: 'audio/sfx/capture_video.mp3',
    },
    ...
    Calibration: {
        ...
        BALL: 'audio/calibration/cal_0.mp3' // same as ZERO for default; custom packs may override
    },
    ...
    Rank: {
        ...
        BEGINT_1_END_BAD: 'audio/lvl/begint/1 end bad.mp3',
        BEGINT_1_END_GOOD: 'audio/lvl/begint/1 end good.mp3',
        BEGINT_1_END_PERFECT: ['audio/lvl/begint/1 end perfect a.mp3', 'audio/lvl/begint/1 end perfect b.mp3'],
        QUICKBG_2_END_BAD: 'audio/lvl/quickbg/2 end bad.mp3',
        QUICKBG_2_END_GOOD: ['audio/lvl/quickbg/2 end good a.mp3', 'audio/lvl/quickbg/2 end good b.mp3'],
        QUICKBG_2_END_PERFECT: 'audio/lvl/quickbg/2 end perfect.mp3',
        COCKW_4_END_PERFECT: 'audio/lvl/cockw/end.mp3',
    },

    // Endless task start (distinct paths; falls back to Level.BEGINT_1_START if pack has no Endless.ENDLESS)
    Endless: {
        ENDLESS: ['audio/lvl/endless/1 start a.mp3', 'audio/lvl/endless/1 start b.mp3'],
    },

    // Level events
    Level: {
        BEGINT_1_START: ['audio/lvl/begint/1 start a.mp3', 'audio/lvl/begint/1 start b.mp3'],
        QUICKBG_2_START: 'audio/lvl/quickbg/2 start.mp3',
        BASICR_3_START: ['audio/lvl/basicr/3 start.mp3', 'audio/lvl/basicr/3 start b.mp3'],
        COCKW_4_START: 'audio/lvl/cockw/start.mp3',
        INTMED_5_START: ['audio/lvl/5 intmed a.mp3'],
        ENDURANCE_6_START: ['audio/lvl/6 endurance a.mp3'],
        DEEPFOCUS_7_START: ['audio/lvl/7 deepfocus a.mp3'],
        SPEED_8_START: ['audio/lvl/8 speed a.mp3'],
        DEVOTION_9_START: ['audio/lvl/9 devotion a.mp3'],
        MAXDEPTH_10_START: ['audio/lvl/10 maxdepth a.mp3'],
        ELITE_11_START: ['audio/lvl/11 elite a.mp3'],
        MANYLOAD_12_START: ['audio/lvl/12 manyload a.mp3'],
    ...
    UpDown: {
        ...
        ONE_THREE_MED: ['audio/updown/1to3 med a.mp3', 'audio/updown/1to3 med b.mp3'],
        ...
        ONE_FOUR_MED: ['audio/updown/1to4 med a.mp3'],
    ...
    Speak: {
        Speak1: ['audio/lvl/0 start a.mp3', 'audio/lvl/0 start b.mp3'],
        Speak2: ['audio/lvl/5 intmed a.mp3'],
        Speak3: ['audio/lvl/6 endurance a.mp3'],
        Speak4: ['audio/lvl/7 deepfocus a.mp3'],
        Speak5: ['audio/lvl/8 speed a.mp3'],
    },
    ...
    Release: {
        ...
        BASICR_3_PRE_RELEASE: 'audio/lvl/basicr/pre release.mp3',
        BASICR_3_POST_RELEASE: 'audio/lvl/basicr/post release.mp3',
        COCKW_4_PRE_RELEASE_1: 'audio/lvl/cockw/pre release 1.mp3',
        COCKW_4_PRE_RELEASE_2: 'audio/lvl/cockw/pre release 2.mp3',
        COCKW_4_PRE_RELEASE_3: 'audio/lvl/cockw/pre release 3.mp3',
        COCKW_4_POST_RELEASE: 'audio/lvl/cockw/post release.mp3',
    }
}
